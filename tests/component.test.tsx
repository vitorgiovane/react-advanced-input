...
import TimeInput from '../src/index';
...
describe('Component', () => {
  ...
  beforeEach(() => {
    ...
    onChangeA = jest.fn();
    onChangeB = jest.fn();
    a = mount(<TimeInput value={'12:34'} onChange={onChangeA} />);
    b = mount(<TimeInput value={'12:34:56'} onChange={onChangeB} showSeconds />);
  });
  ...
  test('should render custom input field', () => {
    const customInput = shallow(<TimeInput value={'12:34'} onChange={onChangeA} input={<input id="lol" />} />);
